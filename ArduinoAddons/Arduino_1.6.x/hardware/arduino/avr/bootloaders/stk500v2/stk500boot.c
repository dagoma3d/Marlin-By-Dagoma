...
//************************************************************************
//*	Issue : On MKS BASE, when all drivers are puggled, driver Y vibrate while its enable pin set to Output.
#define _FIX_ISSUE_MKS_BASE_VIBRATING_DRIVE_AT_STARTUP
...
#ifdef _FIX_ISSUE_MKS_BASE_VIBRATING_DRIVE_AT_STARTUP
	//* Quickly set X, Y, Z drivers enable pins TO OUTPUT
	//* Then, Quickly set these outputs to disable driver activities.
	DDRF = DDRF | 0xC7;
	PORTF = PORTF | 0xC7;
#endif
