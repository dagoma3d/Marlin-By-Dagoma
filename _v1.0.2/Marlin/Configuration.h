...
#define TEMP_SENSOR_BED 11 //100K thermistance B=3950
...
const bool Z_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. true for the palper
...
#define DISABLE_Z true // dagoma discovery
...
#define HOMING_FEEDRATE {150*60, 150*60, 6*60, 0}  // set the homing speeds (mm/min)
