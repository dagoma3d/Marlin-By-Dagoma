# coding=utf-8
#Name: Pause at height (ByDagoma)
#Info: Fait faire une pause à l'imprimante à une certaine hauteur ou une certaine couche.
#Depend: GCode
#Type: postprocess
#Param: pauseLevel(float:5.0) Hauteur de pause (mm)
#Param: pauseLevelLayer(int:) (Sinon) Préciser un numéro de couche
